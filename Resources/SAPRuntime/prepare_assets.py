...
from sap_assets import verify_archive, verify_directory, write_archive
...
def main():
    ...
    destination = repository / "Packages/ApplePackage/Sources/ApplePackage/Resources/SAPAssets.zip"
...
''')
    ...
    write_archive(temporary_assets, destination)
    verify_archive(destination)
